...
import { VoucherDocument } from "@/modules/bookings/presentation/booking-document";
...
/** The voucher for one booking (CLAUDE.md §13, Phase 5c). */
export default async function VoucherPage({
  ...
  return (
    <>
      ...
      <VoucherDocument booking={booking} company={company} locale={locale} />
    </>
  );
}
