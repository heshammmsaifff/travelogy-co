...
/** One booking, as the agent who made it sees it (CLAUDE.md §13, Phase 5a). */
export default async function AgentBookingPage({
  ...
  // RLS returns nothing for another company's booking, so "not found" and
    ...
    <main className="mx-auto max-w-4xl space-y-6 px-4 py-8 sm:px-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {/* The agent may cancel their own booking but never confirm it —
              confirmation is the operator's word that the hotel accepted it. */}
          <BookingControls
